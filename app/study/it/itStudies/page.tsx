...
import { ArrowLeft, Check, ChevronsUp, Plus } from 'lucide-react'

import { fetchItDic, fetchItDics, mergeItDic } from '@/actions/study/study-action'
import { checkUser } from '@/contexts/RooterContext'
import { Breadcrumb } from '@/components/Breadcrumb'
import Modal from '@/components/Modal'
import { ItDicsView, initialItDics } from '@/types/study/study-types'
...
const ItStudies = () => {
  ...
  const loadData = async () => {
    const fetchData = await fetchItDics()
    setItDics(fetchData)
  }
